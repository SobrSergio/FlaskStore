...
В проекте есть: <br>
  <ul dir="auto">
<li>Полная админка с добавление товаров, категорий, брендов, вывода заказов.</li>
<li>Полнстью рабочая корзина товаров.</li>
<li>Пользователи могут добавить товар в корзину, выбрав размер, оформить заказ доставкой/самовызовов.</li>
...
<p>1. Ввести свои данные в config (Подключить базу данных, ввести почту для admin)</p>
